...
<header class="container px-0 my-4">
    <div class="row col-12 d-flex px-0 mx-0">
        ...
        <div id="search-controller" class="d-flex align-items-center
                                    col-12 pt-3
    ...
    <div class="container">
        ...
        <!--<div id="catalog">
            <div class="feturedItems w-100 d-flex flex-wrap justify-content-around">
                <div class="feturedItem" v-for="item of catalogItems" :key="item.productId">
                    <div class="feturedItem fetured_items_link">
