        ...
        <div class="modal-question-form">
                ...
                <form action="">
                    <div class="form">
                        ...
                        <p>Текст</p>
                        <textarea cols="25" rows="4" style="resize: none;" name="text"></textarea>
                    </div>
            ...
            <header class="container px-0 my-4">
                <div class="row col-12 d-flex px-0 mx-0">
                    ...
                    <div class="d-flex align-items-center
                                        ...
                                        pt-sm-3 ">
                        <div class="dropdown">
                            <button class=" btn-lg btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2"
                    ...
                    <div class="row headerAccountAndCart d-none  align-items-center
                        ...
                        <div class="headerCart pr-4">
                            ...
                            <basketComponent  v-show="showBasket" ref="basketComponent" />
                        </div>
                ...
                <div class="row mx-0 d-md-none pt-3 justify-content-between">
                    ...
                    <div class="burgermenu justify-content-between align-items-center
                                    ...
                                    col-sm-6">
                        <div class="dropdown">
                            <button class="btn btn-secondary px-4 pt-2" type="button" id="dropdownMenu2"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                    class="burgerMenu fas fa-bars"></i></button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    ...
                    <div class="offers row mt-5 pt-0 pt-lg-5">
                        ...
                        <div class="col-10 offset-1 offset-sm-0 col-sm-6 d-flex flex-wrap">
                            <div class="offer order-2 mt-4 mt-md-0 order-md-1">
                                ...
                                <a class="one" href="#"><img src="" alt=""></a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="offerWomenRight d-flex flex-column px-0 col-12
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center
                                    flex-lg-row">
                                    <div class="">
                                        <img src="../src/assets/imgs/Truck.png" alt="">
                                    </div>
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center
                                    flex-lg-row">
                                    <div class="">
                                        <img src="../src/assets/imgs/percent.png" alt="">
                                    </div>
                                    <div class="offerWomenDetail">
                                        <div class="offerWomenDetailUp">Free Delivery</div>
                                        <div class="offerWomenDetailBottom">Worldwide delivery on all. Authorit tively morph
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center
                                    flex-lg-row">
                                    <div class="">
                                        <img src="../src/assets/imgs/Crown.png" alt="">
                                    </div>
                                    <div class="offerWomenDetail">
                                        <div class="offerWomenDetailUp">Free Delivery</div>
                                        <div class="offerWomenDetailBottom">Worldwide delivery on all. Authorit tively morph
...
export default {
    components: { 'catalogComponent': Catalog, 'basketComponent': Basket }, 
/*     conponents: {  Catalog, Basket }, */
/*     conponents: {  Catalog, 'basket-comp': Basket }, */
    data() {
        return {              
            showBasket: true,
        }
