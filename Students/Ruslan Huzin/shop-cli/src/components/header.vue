    ...
    <header class="container px-0 my-4">
      <div class="row col-12 d-flex px-0 mx-0">
        ...
        <div class="d-flex align-items-center
          ...
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Search for Item..." aria-label="Recipient's username"
      ...
      <div class="row mx-0 d-md-none pt-3 justify-content-between">
        ...
        <div class="burgermenu justify-content-between align-items-center
                                    ...
                                    col-sm-6">
          <div class="dropdown">
            <button class="btn btn-secondary px-4 pt-2" type="button" id="dropdownMenu2" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false"><i class="burgerMenu fas fa-bars"></i></button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
